...
import {
  ...
  where
} from "./chunk-W44X7LZ7.js";
import "./chunk-Q3R4TSSL.js";
import {
  FirebaseApp,
  VERSION as VERSION2,
...
import {
  ...
  registerVersion,
  uuidv4
} from "./chunk-7D6FYZYY.js";
import {
  isPlatformServer
} from "./chunk-WDXB333S.js";
import {
  Inject,
  Injectable,
  InjectionToken,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name4, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-K4XDD4RK.js"))), map(() => ɵfirebaseAppFactory(options, zone, name4)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
